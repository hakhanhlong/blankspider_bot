...
{
    public class ArchiviedManager: BaseSpiderManagement
    {
        //private Source _source;

        public ArchiviedManager() {
            SpiderSingletonEvent.Instance.SpiderReloadForUpdate += Instance_SpiderReloadForUpdate;
        }

        private readonly object _lock = new object();

        public ArchiviedManager(string name):base(name) { }
        

        public ArchiviedManager(string name, string sourceid)
            : base(name, sourceid)
        {
            this.Name = name;
        ...
        public override void LoadConfigGeneral()
        {
            ...
            try
            {
                ...
                this._VIDEO_POST_URL = config.video_post_url;
