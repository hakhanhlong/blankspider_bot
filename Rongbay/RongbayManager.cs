...
namespace Rongbay
{
    public class RongbayManager: BaseSpiderManagement
    {
        public RongbayManager()
        {
        ...
        public RongbayManager(string name) : base(name) { }


        public RongbayManager(string name, string sourceid)
            : base(name, sourceid)
        {
            this.Name = name;
